      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 mt-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div data-aos="fade-right">
             <p className="text-lg font-bold text-[#1E3A8A] mb-6 leading-tight border-b-2 w-42">
              Mechanical Repairs
            </p>
            <h4 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#1E3A8A] mb-6 leading-tight">
            All Types of Mechanical Repairs for Your Vehicle
            </h4>
            ...
            >
             From minor faults to major overhauls, our expert technicians handle all types of mechanical repairs with precision and care. We use advanced diagnostics, quality parts, and proven methods to keep your car safe, smooth, and road-ready.
            </p>
