  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundImage: "url('/bg.jpg')" }} // Replace with your public folder image
      ></div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-10 text-center">
        ...
        >
          <a
            ...
            className="bg-[#969695] text-[#1E3A8A] px-8 py-3 rounded-full font-semibold text-lg md:text-xl shadow-md hover:shadow-[#969695]/50 hover:scale-105 transition-all duration-300 flex items-center gap-2 justify-center"
          >
...
export default ReliableRepairsSection;