      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 mt-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div data-aos="fade-right">
             <p className="text-lg font-bold text-[#1E3A8A] mb-6 leading-tight border-b-2 w-15">
              Service
            </p>
            <h4 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#1E3A8A] mb-6 leading-tight">
             Routine Vehicle Servicing for Optimal Performance
            </h4>
            ...
            >
             Keep your vehicle running smoothly and efficiently with our comprehensive servicing packages. From routine maintenance to detailed inspections, we help extend your car’s lifespan and prevent costly breakdowns.
            </p>
