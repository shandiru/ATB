...
const Navbar = () => {
  ...
  return (
    ...
    >
          ...
          {navLinks.map((link, idx) => {
              ...
              return (
                <div key={idx} className="relative" ref={dropdownRef}>
                  <button
                    ...
                    className={`flex items-center gap-1 text-[16px] tracking-wide font-medium transition-all duration-300 outline-none ${
                  ...
                  <div
                    className={`absolute left-0 mt-4 w-52 bg-[#0F216B] rounded-md shadow-xl border border-white/10 transition-all duration-300 z-50 ${
                      servicesOpen
            ...
            return (
              <Link
                ...
                key={idx}
                to={link.href}
                className={`relative text-[16px] tracking-wide font-medium transition-all duration-300 group ${
                  scrolled ? "text-white" : "text-gray-200"
                }`}
              >
                {link.label}
      ...
      <div
        className={`lg:hidden transition-all duration-500 ease-in-out bg-[#0F216B] overflow-y-auto ${
                ...
                <div key={idx} className="w-full">
                  ...
                  <div
                    className={`flex flex-col overflow-hidden transition-all duration-500 ease-in-out ${
                      servicesOpen ? "max-h-[500px] mt-2 opacity-100" : "max-h-0 opacity-0"
                    }`}
                  >
                    {link.dropdown.map((item, i) => (
                      <Link
