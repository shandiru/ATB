  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-10 text-center">
        ...
        >
          Our welding work combines precision, craftsmanship, and durability. Whether it’s a simple patch repair or full chassis restoration, every job meets professional safety standards and delivers long-term performance.
        </p>
...
export default BuiltStrongSection;