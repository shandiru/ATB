      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 mt-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div data-aos="fade-right">
            <p className="text-lg font-bold text-[#1E3A8A] mb-6 leading-tight border-b-2 w-18">
              Welding
            </p>
            <h4 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#1E3A8A] mb-6 leading-tight">
            Professional Automotive Welding Services
            </h4>
            ...
            >
             From structural chassis repairs to custom fabrication, our expert welding services restore strength, safety, and precision to your vehicle. Using industry-grade equipment and materials, we ensure every weld is strong, clean, and built to last.
            </p>
